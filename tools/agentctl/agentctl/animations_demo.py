...
def demo_gradients():
    ...
    for gradient in gradients:
        text = f"  {gradient.upper():12} → AgentCtl - Agentic Framework CLI"
...
def main():
    ...
    title = Panel(
        Text.from_markup(
            "[bold cyan]AgentCtl Animation Demo[/bold cyan]\n\n"
    ...
    try:
        ...
        final_panel = Panel(
            GradientText.apply(
                "Demo Complete! All animations ready to use in AgentCtl.",
                gradient="cyberpunk",
            ),
            border_style="green",
            padding=(1, 2),
