"""
Tool Executor for AgentCtl LLM Integration.

Module: agentctl/tool_executor.py

Executes AgentCtl commands based on LLM tool calls.
...
# Path: tool_executor.py -> agentctl -> agentctl -> tools -> agent-framework
_project_root = Path(__file__).parents[3]  # agentctl(dir) -> tools -> agent-framework
...
class ToolExecutor:
    """Executes AgentCtl tools from LLM function calls."""
    ...
    def __init__(self, config_dir: str = ".agentctl"):
        """
    ...
    def _exec_mcp_call(
        ...
        try:
            ...
            return {
                ...
                "hint": "Ensure gateway is running: check with /status or start with agentctl",
            }
        except Exception as e:
            return {
                "success": False,
    ...
    def _exec_list_llm_providers(self) -> Dict[str, Any]:
        ...
        This matches the command-line 'agentctl llm list' output.
        """
...
List with: /mcp list
    ...
    def _exec_python_exec(
        ...
        try:
            ...
            auto_install_env = os.getenv("AGENTCTL_AUTO_INSTALL_PACKAGES", "true").lower()
    ...
    def _exec_web_search_duckduckgo(
        ...
        try:
            ...
            return {
                ...
                "results": [],
                "fix": "Run: cd /Users/paragpradhan/Projects/Agent\\ framework/agent-framework/tools/agentctl && source .venv/bin/activate && uv pip install ddgs",
            }
    ...
    def _load_websearch_config(self) -> Dict[str, Any]:
        ...
        env_provider = os.getenv("AGENTCTL_WEBSEARCH_PROVIDER")
        if env_provider:
