...
def load_config(config_dir: str = ".agentctl") -> Config:
    """
...
def save_config(config: Config, config_dir: str = ".agentctl") -> None:
    """
...
def get_llm_config_path(config_dir: str = ".agentctl") -> Path:
    """Get path to LLM configuration file."""
    return Path(config_dir) / "llm.yaml"


def load_llm_config(config_dir: str = ".agentctl") -> Dict[str, Any]:
...
def save_llm_config(llm_config: Dict[str, Any], config_dir: str = ".agentctl") -> None:
