...
Module: agentctl/commands/runtime.py
"""
...
def run_cmd(ctx: click.Context) -> None:
    ...
    config_dir = ctx.obj.get("config_dir", ".agentctl")
...
[bold]Commands:[/bold]
  - View status: agentctl /status
  - View logs:   agentctl /logs
...
def run_project_programmatic(config_dir: str = ".agentctl") -> dict:
    """
...
def show_status_programmatic(config_dir: str = ".agentctl") -> dict:
    """
