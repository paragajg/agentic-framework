...
Module: agentctl/iteration_display.py
...
def get_display_mode() -> DisplayMode:
    ...
    env_mode = os.getenv("AGENTCTL_DISPLAY_MODE", "").lower()
...
def get_output_mode() -> OutputMode:
    ...
    # Check environment variable first
    env_mode = os.getenv("AGENTCTL_OUTPUT_MODE", "").lower()
...
def display_sources_panel(console: Console) -> None:
    ...
    Args:
        console: Rich console for output
    """
    from agentctl.tool_executor import get_source_tracker, SourceType
