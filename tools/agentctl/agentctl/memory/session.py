"""
Session Management for AgentCtl Memory System.
...
Module: agentctl/memory/session.py
"""
...
class SessionManager:
    ...
    SESSION_KEY_PREFIX = "agentctl:session:"
    ACTIVE_SESSION_KEY = "agentctl:active_session:"
    USER_KEY_PREFIX = "agentctl:user:"
    ...
    def _get_or_create_user_id(self) -> str:
        ...
        User ID is stored in ~/.agentctl/user_id and persisted.
        """
    ...
    def save_interaction(self, interaction: Interaction) -> bool:
        ...
        key = f"agentctl:interaction:{interaction.interaction_id}"
