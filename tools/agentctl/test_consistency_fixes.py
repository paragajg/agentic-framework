...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "agentctl"))

from agentctl.tool_executor import ToolExecutor
from agentctl.commands.llm import list_llm_providers
...
def test_mcp_consistency():
    ...
    console.print("  Would call: agentctl mcp list")
