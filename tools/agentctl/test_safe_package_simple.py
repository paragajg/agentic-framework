...
This tests the SafePackageManager directly without importing the full agentctl package.
"""
...
spec = importlib.util.spec_from_file_location(
    ...
    os.path.join(os.path.dirname(__file__), "agentctl", "safe_package_manager.py")
)
