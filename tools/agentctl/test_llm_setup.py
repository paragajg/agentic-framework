...
def test_openai_connection():
    ...
    try:
        ...
        response = client.chat.completions.create(
            model="gpt-4o-mini",
            messages=[{"role": "user", "content": "Say 'Hello from AgentCtl!'"}],
            max_tokens=20,
        )
...
def test_llm_client():
    """Test AgentCtl LLM client."""
    print("\n" + "=" * 80)
    print("STEP 3: Testing AgentCtl LLM Client")
    print("=" * 80)

    try:
        from agentctl.llm_client import AgentCtlLLMClient

        print("Initializing LLM client...")
        client = AgentCtlLLMClient()
        ...
        print("\nMake sure you're in the agentctl directory:")
        print("  cd tools/agentctl")
        return False
...
def main():
    ...
    print("\n" + "=" * 80)
    print("AGENTCTL LLM CONNECTION DIAGNOSTIC")
    print("=" * 80 + "\n")
    ...
    print("\n" + "=" * 80)
    print("Your AgentCtl LLM setup is working correctly!")
    print("=" * 80)
    print("\nYou can now run:")
    print("  agentctl")
    print("\nOr:")
    print("  python -m agentctl.cli")
    print()
