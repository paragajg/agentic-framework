...
agentctl_path = os.path.join(os.path.dirname(__file__), '../agentctl')
if os.path.exists(agentctl_path):
    sys.path.insert(0, os.path.dirname(agentctl_path))

try:
    from agentctl.safe_package_manager import SafePackageManager
    ...
    print("This is expected if agentctl is not installed as a package")
