"""
Test script for external MCP server integration via agentctl.
...
from agentctl.mcp_gateway_client import (
    MCPGatewayClient,
...
def main():
    ...
    console.print(
        Panel(
            ...
            "This will test the agentctl external MCP server integration.\n"
